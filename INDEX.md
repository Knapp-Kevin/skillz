...
| Persisted third-party exact-version reviews | 427 |
...
The Addy Osmani family is pinned at `f63ec56a3cc936408d792956ae583c3c96a825bd`; the exact upstream denominator is **24** first-class `skills/*/SKILL.md` packages, matching historical #27. The latest current-standard pair is `frontend-ui-engineering`, recovered from exact historical evidence in superseded PR #42 and verified **16/20** at exact blob `837df875900d4d431c6d51a3251bac0d4bd5dfed`, with behavioral validation `not-run`. Its design-system-first, accessibility, responsive, loading/error/empty-state, and rendered-verification discipline are useful. Portability remains medium because examples lean on React/TSX and Tailwind-style conventions and accessibility verification benefits from browser/axe tooling; fixed breakpoint, component-size, and prop-drilling thresholds are judgment heuristics rather than universal rules. Nine companion gaps remain and should preferentially reuse compatible historical evidence.
