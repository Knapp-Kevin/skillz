...
AWS is complete at **72/72**. Microsoft Skills is complete at **186/186**. Microsoft Azure Skills is complete at **34/34**. Cole Medin Skills is complete at **33/33**. Matt Pocock Skills is complete at **29/29** after excluding `deprecated` and `in-progress` according to the registered source policy.
