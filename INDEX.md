...
| Persisted third-party exact-version reviews | 304 |
...
AWS is fully reconciled at **72/72**. Microsoft Skills is active at **132/189**, leaving **57** gaps. Direct `.NET`, Java, Python, Rust, and TypeScript slices are complete. Direct TypeScript is **25/25** from the registered-pin tree. The TypeScript plugin README claims 24 and omits the separately present `applicationinsights-web-ts` package, so the 25-package tree controls.
...
The next Microsoft Skills gap in registered-pin source order is `.github/plugins/azure-skills/skills/airunway-aks-setup`.
