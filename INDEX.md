...
| Persisted third-party exact-version reviews | 423 |
...
The Addy Osmani family is pinned at `f63ec56a3cc936408d792956ae583c3c96a825bd`; the exact upstream denominator is **24** first-class `skills/*/SKILL.md` packages, matching historical #27. The latest current-standard pair is `documentation-and-adrs`, verified **19/20** at exact blob `7faf52c9558fa60faf7362cf473cf24784f9209b`, behavioral validation `not-run`. Thirteen companion gaps remain and should preferentially reuse compatible historical evidence.
