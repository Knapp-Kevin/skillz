...
- **577** persisted exact-version third-party verification companions.
...
- Current provenance/verification companions: **40/55**; gaps **15**.
- Current decisive states: **16 verified / 24 rejected unchanged**; behavioral validation remains `not-run` for all reviewed units.
