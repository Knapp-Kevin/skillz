...
- **572** persisted exact-version third-party verification companions.
...
- Current provenance/verification companions: **35/55**; gaps **20**.
- Current decisive states: **16 verified / 19 rejected unchanged**; behavioral validation remains `not-run` for all reviewed units.
...
Continue issue #66 with the David Ondrej frontier now at **35/55 current-standard companion pairs, 20 genuine gaps**. Skill authoring, agent orchestration, and ops-and-setup are current-standard complete at **4/4**, **17/17**, and **11/11**. Continue the bounded research-and-web category, now **3/10**, after checking current companions and recoverable repository history for each genuine gap; keep discovery/source-vetting and omission detection parallel and secondary.