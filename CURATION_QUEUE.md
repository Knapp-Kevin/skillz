...
- **564** persisted exact-version third-party verification companions.
...
Continue issue #66 with the David Ondrej frontier now at **27/55 current-standard companion pairs, 28 genuine gaps**. Skill authoring and agent orchestration are current-standard complete at **4/4** and **17/17**; ops-and-setup is **6/11** reviewed. Continue that bounded category after checking companions and repository history for genuine gaps, while keeping discovery/source-vetting and omission detection parallel and secondary.