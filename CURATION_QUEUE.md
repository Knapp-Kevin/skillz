...
- **567** persisted exact-version third-party verification companions.
...
Continue issue #66 with the David Ondrej frontier now at **30/55 current-standard companion pairs, 25 genuine gaps**. Skill authoring and agent orchestration are current-standard complete at **4/4** and **17/17**; ops-and-setup is **9/11** reviewed. Continue that bounded category after checking companions and repository history for genuine gaps, while keeping discovery/source-vetting and omission detection parallel and secondary.