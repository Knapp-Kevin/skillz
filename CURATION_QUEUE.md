...
- **282** persisted exact-version third-party verification companions.
...
- Current-standard companions: **110/189**.
- Remaining gaps: **79**.
- Direct `.NET`: **29/29** complete.
- Direct Java: **26/26** complete.
- Direct Python: **40/40** complete.
- Direct Rust: **9/9** complete.
- Direct TypeScript: **3/25** complete.
...
All three retain `validation_status: not-run`. Exact tree/blob identities and skill-specific freshness are retained in individual companion records.

**Next:** `azure-ai-projects-ts`, then continue the registered-pin TypeScript tree source-order in coherent batches.
...
**Microsoft Skills:** **110/189**, **79 gaps**. Direct `.NET`, Java, Python, and Rust slices are complete; TypeScript is active at **3/25**.  
**Next:** `azure-ai-projects-ts` in the registered-pin TypeScript tree.