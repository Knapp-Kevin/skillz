...
- **185** persisted exact-version third-party verification companions.
...
- Current-standard provenance + verification companions persisted: **13/189**.
- Remaining current-standard gaps: **176**.
...
- Continue sequential review from the pinned tree and check both companion paths before every unit. The `.github/plugins/azure-sdk-dotnet/skills/` slice contains **29** direct skill-package directories; nine currently have current-standard companions (`azure-identity-dotnet`, `azure-ai-document-intelligence-dotnet`, `azure-ai-agents-persistent-dotnet`, `azure-ai-openai-dotnet`, `azure-ai-projects-dotnet`, `azure-ai-voicelive-dotnet`, `azure-eventgrid-dotnet`, `azure-eventhub-dotnet`, `azure-maps-search-dotnet`).
...
**Active frontier:** Microsoft Skills, now **13/189** current-standard companion-complete with **176** gaps. Microsoft Azure Skills follows. Discovery and issue/PR hygiene continue in parallel.