...
- **578** persisted exact-version third-party verification companions.
...
- Current provenance/verification companions: **41/55**; gaps **14**.
- Current decisive states: **16 verified / 25 rejected unchanged**; behavioral validation remains `not-run` for all reviewed units.
...
Continue issue #66 with the David Ondrej frontier now at **41/55 current-standard companion pairs, 14 genuine gaps**. Skill authoring, agent orchestration, and ops-and-setup are current-standard complete at **4/4**, **17/17**, and **11/11**. Finish the bounded research-and-web category, now **9/10**, after checking current companions and recoverable repository history for the final genuine gap, `youtube-transcript`. Corey Haines Marketing Skills is an admitted tracked corpus at **0/50** and should receive selective exact-version review after the higher-priority David frontier, beginning with differentiated marketing mechanisms rather than wholesale approval.