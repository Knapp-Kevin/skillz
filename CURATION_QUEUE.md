...
- **583** persisted exact-version third-party verification companions.
...
- Current provenance/verification companions: **46/55**; gaps **9**.
- Current decisive states: **18 verified / 28 rejected unchanged**; behavioral validation remains `not-run` for all reviewed units.
