...
- **581** persisted exact-version third-party verification companions.
...
- Current provenance/verification companions: **44/55**; gaps **11**.
- Current decisive states: **17 verified / 27 rejected unchanged**; behavioral validation remains `not-run` for all reviewed units.
...
Continue issue #66 with the David Ondrej frontier now at **44/55 current-standard companion pairs, 11 genuine gaps**. Skill authoring, agent orchestration, ops-and-setup, and research-and-web are current-standard complete at **4/4**, **17/17**, **11/11**, and **10/10**. Continue thinking-and-docs, now **2/13**, after checking current companions and recoverable repository history for each genuine gap; next candidate is `brain-to-docs`. Corey Haines Marketing Skills is an admitted tracked corpus at **0/50** and should receive selective exact-version review after the higher-priority David frontier, beginning with differentiated marketing mechanisms rather than wholesale approval.