...
- **283** persisted exact-version third-party verification companions.
...
- Current-standard companions: **111/189**.
- Remaining gaps: **78**.
- Direct `.NET`: **29/29** complete.
- Direct Java: **26/26** complete.
- Direct Python: **40/40** complete.
- Direct Rust: **9/9** complete.
- Direct TypeScript: **4/25** complete.
...
All four retain `validation_status: not-run`. Exact tree/blob identities and skill-specific freshness are retained in individual companion records.

**Next:** `azure-ai-translation-ts`, then continue the registered-pin TypeScript tree source-order in coherent batches.
...
**Microsoft Skills:** **111/189**, **78 gaps**. Direct `.NET`, Java, Python, and Rust slices are complete; TypeScript is active at **4/25**.  
**Next:** `azure-ai-translation-ts` in the registered-pin TypeScript tree.