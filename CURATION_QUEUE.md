...
- **587** persisted exact-version third-party verification companions.
...
- Current provenance/verification companions: **50/55**; gaps **5**.
- Current decisive states: **19 verified / 31 rejected unchanged**; behavioral validation remains `not-run` for all reviewed units.
