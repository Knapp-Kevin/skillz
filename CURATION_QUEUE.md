...
- Current-standard provenance + verification companions persisted: **9/189**.
- Remaining current-standard gaps: **180**.
...
- Continue sequential review from the pinned tree and check both companion paths before every unit. The `.github/plugins/azure-sdk-dotnet/skills/` slice contains **29** direct skill-package directories; five currently have current-standard companions (`azure-identity-dotnet`, `azure-ai-document-intelligence-dotnet`, `azure-ai-agents-persistent-dotnet`, `azure-ai-openai-dotnet`, `azure-ai-projects-dotnet`).
...
**Active frontier:** Microsoft Skills, now **9/189** current-standard companion-complete with **180** gaps. Microsoft Azure Skills follows. Discovery and issue/PR hygiene continue in parallel.