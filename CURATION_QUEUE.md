...
- **584** persisted exact-version third-party verification companions.
...
- Current provenance/verification companions: **47/55**; gaps **8**.
- Current decisive states: **18 verified / 29 rejected unchanged**; behavioral validation remains `not-run` for all reviewed units.
