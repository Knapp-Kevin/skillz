...
Macro tranche 02 adds: `lead-magnets` **14/20**, `marketing-council` **14/20**, `marketing-ideas` **14/20**, `marketing-loops` **14/20**, `marketing-plan` **13/20**, `marketing-psychology` **13/20**, `offers` **13/20**, and `onboarding` **14/20**.
