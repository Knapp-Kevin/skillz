...
- **579** persisted exact-version third-party verification companions.
...
- Current provenance/verification companions: **42/55**; gaps **13**.
- Current decisive states: **16 verified / 26 rejected unchanged**; behavioral validation remains `not-run` for all reviewed units.
...
- Historical issue #47 / PR #50 accounting of **44** skills for this same public pin is superseded by direct pinned-tree evidence. No state is inferred for the remaining 13.
...
Continue issue #66 with the David Ondrej frontier now at **42/55 current-standard companion pairs, 13 genuine gaps**. Skill authoring, agent orchestration, ops-and-setup, and research-and-web are current-standard complete at **4/4**, **17/17**, **11/11**, and **10/10**. Reconcile recoverable repository history for thinking-and-docs before fresh review of its **13** genuine gaps. Corey Haines Marketing Skills is an admitted tracked corpus at **0/50** and should receive selective exact-version review after the higher-priority David frontier, beginning with differentiated marketing mechanisms rather than wholesale approval.