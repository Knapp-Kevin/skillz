...
| **Persisted third-party review companions** | 324 |
| **Pinned external corpora** | 12 |
| **Registered source identities** | 19 |
| **AWS current-standard companion complete** | 72 / 72 |
| **Microsoft Skills current-standard companions** | 152 / 189 |
| **Microsoft Skills current-standard gaps** | 37 |
...
- Microsoft Skills: exact denominator **189**, **152/189 companion-complete**, **37 gaps** at pin `32cad4ee689c95c309e61aeefcbc6af356f1e6a7`.
...
The non-direct Microsoft plugin frontier is active. Reviewed packages now include `airunway-aks-setup` (15/20), `appinsights-instrumentation` (12/20), `azure-ai` (10/20), `azure-aigateway` (8/20), `azure-cloud-migrate` (9/20), `azure-compliance` (12/20), `azure-compute` (11/20), `azure-cost` (14/20), `azure-deploy` (15/20), `azure-diagnostics` (13/20), `azure-enterprise-infra-planner` (verified, 18/20), `azure-hosted-copilot-sdk` (13/20), `azure-kubernetes` (12/20), `azure-kubernetes-automatic-readiness` (15/20), `azure-kusto` (14/20), `azure-messaging` (13/20), `azure-prepare` (16/20), `azure-quotas` (14/20), `azure-rbac` (verified, 17/20), and `azure-reliability` (**rejected, 15/20**). `azure-reliability` is bound to package tree `1240c9672f0101c65ab0dbc461f9515a200b4486`, `SKILL.md` blob `835bc5e854d9cabfc6021a9bfc6d7fbb8c594abb`, freshness revision `c5efa32e0ef4922d693785014258f7a0aefae259` from 2026-05-27. Preserve its scoped reliability assessment, live-vs-IaC path choice, separate storage-migration consent, source-code consent, and multi-region hard stop. Unchanged adoption is rejected because bundled storage guidance emits a live storage connection string into CLI output and reuses it in app settings instead of requiring secure external secret transfer. Behavioral validation is `not-run`.

Microsoft Skills remains active with **37** gaps. Establish the next gap from the registered-pin tree after `azure-reliability`.
...
1. Continue Microsoft Skills in registered-pin source order from the first genuine gap after `azure-reliability`.
