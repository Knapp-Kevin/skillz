...
| **Persisted third-party review companions** | 235 |
| **Pinned external corpora** | 12 |
| **Registered source identities** | 19 |
| **AWS historical review** | 72 / 72 |
| **AWS current-standard companion complete** | 72 / 72 |
| **AWS current-standard gaps** | 0 |
| **Microsoft Skills current-standard companions** | 63 / 189 |
| **Microsoft Skills current-standard gaps** | 126 |
| **Microsoft .NET direct-package companions** | 29 / 29 |
| **Microsoft Java direct-package companions** | 26 / 26 |
| **Microsoft Python direct-package companions** | 4 / 40 |
...
- **235 exact-version third-party verification companions** are persisted.
...
- Microsoft Skills has an exact eligible denominator of **189** independently front-mattered skill entry points at registered pin `32cad4ee689c95c309e61aeefcbc6af356f1e6a7`; **63/189** have current-standard provenance + verification companions and **126** remain.
...
- The direct `.github/plugins/azure-sdk-python/skills/` slice contains **40** packages and is **4/40 current-standard companion-complete**.
...
Current progress is **63/189** current-standard companion-complete. Previously reconciled units include root/cross-language packages, the complete direct `.NET` SDK plugin slice, the complete direct Java SDK plugin slice, and the first four direct Python packages.
...
The direct Python plugin has an exact denominator of **40** packages and is **4/40 current-standard companion-complete** at the registered pin. `agent-framework-azure-ai-py`, `azure-ai-contentsafety-py`, `azure-ai-contentunderstanding-py`, and `azure-ai-language-conversations-py` now have exact provenance + verification companions with differentiated rejection reasons rather than source-level approval. The next source-ordered package remains the active frontier.
...
1. Continue Microsoft Skills in coherent source-ordered plugin/language batches against the exact **189-entry** denominator; direct Python is the active tranche at **4/40**.
